...
ip_and_unemployment <- read.csv("/Users/james.chattock/Desktop/Copy of data for data scientists/week02/ip_and_unemployment.csv") # nolint: line_length_linter.
```
...
ipu_clean %>%
  ...
  filter(unemployment == max(unemployment, na.rn = TRUE)  | 
           ip == min(ip, na.rm = TRUE))
